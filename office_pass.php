...
if(isset($_SESSION['userid'])== true)
{
 $id=$_SESSION['userid'];
  if(isset($_POST['pass']))
  {
  	...
  	$query = "SELECT PASSWORD FROM OFFICE WHERE ID= '$id'";
  	...
  	{
  	  $sql="UPDATE OFFICE SET PASSWORD = '$new_pass' WHERE ID = '$id' ";
...
<form action = "<?php echo $_SERVER['PHP_SELF'];?>" method = "post">
  ...
  <li class="nav-item">
    <a class="nav-link active" href="office_profile.php">Back to Profile Page</a>  </li>
</ul>
